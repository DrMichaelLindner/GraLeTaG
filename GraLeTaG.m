...
%
% Version 0.984 by Michael Lindner 
...
% help button - as pushbutton - bottom right
uicontrol('Style', 'pushbutton', ...
    'String', 'Help', ...
    'Units', 'pixels',...
    'BackgroundColor',BackgroundColor,...
...
uicontrol('Style','text', ...
    ...
    % ------------------------------------------------------------------
    function openhelp(source,event)
        url = ['file:///',fullfile(pwd,'GraLeTag_Manual.html')];
    	web(url)
    end
    ...
    function menu_about_function(~,~)
        ...
        about_text={'GraLeTaG',...
            ...
            '',...
            'This tool is designed to easily generate and',...
            'run Gradient Learning Tasks.',...
            '',...
            'Read the user manual for detailed information about ',...
            'how to use this tool, my pressing teh help button or ',...
            'by opening the GraLeTaG_Manual.html with your browser.',...
            '',...
    ...
    function Prepare_GraLe()
        ...
        function GraLeTaG_GUItest3()
            ...
            uicontrol('Style', 'pushbutton', ...
                ...
                'BackgroundColor',ButtonBackgroundColor,...
                'ForegroundColor',ButtonForegroundColor,...
                'Position', [guix-50,guiy-50,40,40],...
                'Callback',@openhelp);
...
%                 'Callback',@defcuetime);
            ...
            function definst(source,~)
                ...
                if s == 2
                    ...
                    itxt = [insttext0 , '  ',insttext1 , '  ',insttext2];
                elseif s == 3
            ...
            function define_rule_order
                ...
                for voc=1:voc_length
                    rule_edit_user(voc_length+1-voc,1)=uicontrol('Style', 'edit',...
                        ...
                        'ForegroundColor',FontColor,...
                        'BackgroundColor',BoxBackgroundColor,...
                        'Position', [50,upos(voc),100,30]);
                    uicontrol('Style','text', ...
                        'HorizontalAlignment','left', ...
                        'Position',[170,upos(voc)-7,40,30], ...
                        'ForegroundColor',FontColor,...
                        'FontSize',FontSize,...
                        'String','->',...
                        'BackgroundColor',BackgroundColor);
                    ...
                    rule_edit_user(voc_length+1-voc,5) = uicontrol('Style', 'edit',...
                        ...
                        'ForegroundColor',FontColor,...
                        'BackgroundColor',BoxBackgroundColor,...
                        'Position', [670,upos(voc),100,30]);
                    rule_edit_user(voc_length+1-voc,6) = uicontrol('Style', 'edit',...
                        'String', num2str(90),...
                        'FontSize',FontSize,...
                        'ForegroundColor',FontColor,...
                        'BackgroundColor',BoxBackgroundColor,...
                        'Position', [820,upos(voc),100,30]);
                    ...
                    rule_edit_user(voc_length+1-voc,7) = uicontrol('Style', 'popup',...
                        ...
                        'ForegroundColor',FontColor,...
                        'BackgroundColor',BoxBackgroundColor,...
                        'Position', [1000,upos(voc),100,30]);

                end
                
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[50,upos(end)+40,250,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',HeadColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[670,upos(end)+40,250,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',HeadColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[50,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                    'String','Rule numbers:',...
                    'BackgroundColor',BackgroundColor);
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[200,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[350,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[500,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[670,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[820,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                ...
                uicontrol('Style','text', ...
                    'HorizontalAlignment','left', ...
                    'Position',[1000,upos(end)-15,160,30], ...
                    'FontSize',FontSize,...
                    'ForegroundColor',FontColor,...
                    'String','A break after?',...
                    'BackgroundColor',BackgroundColor);
                
                line([50 605],[upos(end)+30 upos(end)+30],...
                    'Color',LineColor,'LineWidth',1,...
                    'parent',ax)
                line([670 910],[upos(end)+30 upos(end)+30],...
                    'Color',LineColor,'LineWidth',1,...
                    'parent',ax)
                ...
                uicontrol('Style', 'pushbutton', ...
                    ...
                    'String', 'Done', ...
                    'Units', 'pixels',...
                    'Position', [fwidth/2-150,10,300,30],...
                    'FontWeight','bold',...
                    'FontSize',FontSize,...
                    'BackgroundColor',ButtonBackgroundColor,...
                    'ForegroundColor',ButtonForegroundColor,...
                                ...
                                if strcmpi(cfg.Equaltriallength,'yes')
                                    if strcmpi(cfg.DotTrialEnd,'stay')
                                        if toc<cfg.Stimprestime/1000
                                            WaitSecs(cfg.Stimprestime/1000-rtime);
                                        end
                                    else
                                        distime=cfg.Stimprestime/1000-rtime;
                                    end
                                end
                            end
